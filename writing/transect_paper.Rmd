...
biblatexoptions: [giveninits=true, maxbibnames=999, maxcitenames=2, mincitenames=1, uniquename=false, uniqueprimaryauthor=false, uniquelist=false, date=year, url=false, isbn=false, eprint=false, doi=true]
...
Read counts for shared ASVs were highly correlated between strategies, with a minimum $R^2$ value of `r compR2("pb_500", "is_057", "ASV")` (Figure\ \@ref(fig:read-compare-asv)).
...
`r compR2("pb_500", "is_057", "ASV")` to `r compR2("pb_500", "is_057", "OTU")`, for PacBio long amplicon reads vs. PacBio, Illumina, and Ion Torrent short amplicon reads, respectively; Figure\ \@ref(fig:read-compare-otu)).
...
and even between primer pairs (R^2^ = `r readd(comparisons) %>% filter(type == "OTU") %>% filter(x_amplicon != y_amplicon) %$% paste(format(range(r.squared), format = "f", digits = 2), collapse = "--")`, Figure \@ref(fig:read-compare-otu)),
