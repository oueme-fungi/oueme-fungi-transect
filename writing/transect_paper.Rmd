...
Although the length profile of the three sequencing runs were very similar, Illumina MiSeq had the largest fraction of reads near the top of the range, followed by Ion Torrent Ion S5 and PacBio RS II (Supplementary Figure\ \@ref(fig:full-length)b).
Although the difference in length distributions was statistically significant (Kruskal-Wallis H = )
