...
light_plan %>%
  ...
  xlab("Distance (m)") +
  ggnomics::facet_nested(metric + tech + amplicon ~ guild, scales = "fixed", nest_line = TRUE) +
...
variog_empir %>%
  ...
  ggnomics::facet_nested(metric + tech + amplicon ~ guild, scales = "free", nest_line = TRUE) +
  theme(strip.background = element_blank())
