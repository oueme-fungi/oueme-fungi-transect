...
Long (short) amplicon sequencing with PacBio yielded `r readd(rawcounts)["pb_500"]` (`r readd(rawcounts)["pb_483"]`) circular consensus reads, of which `r readd(demuxcounts)["pb_500"]` (`r readd(demuxcounts)["pb_483"]`) were successfully demultiplexed.
The 5.8S region was detected in `r readd(regioncounts)["pb_500"]` (`r readd(regioncounts)["pb_483"]`) reads.
Ion Torrent sequencing yielded `r readd(demuxcounts)["is_057"]` demultiplexed reads, with the 5.8S region detected in `r readd(regioncounts)["is_057"]`.
