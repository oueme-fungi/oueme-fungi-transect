...
datasets <- read_csv(here("config/datasets.csv"), col_types = "ccccicccccicc")
...
short, ITS, LSU, long: ITS2-based ASVs mapped to consensus ASVs for longer regions, where \"short\" and \"song\" denote the full-length short and long amplicons, respectively.
