...
- x% of plants, y% of fungi <!-- Brundrett for plants and Ornella Comandini , Andrea C. Rinaldi, Thomas W. Kuyper for fungi (with some calculations) - Martin -->
...
- Not easy to culture, so we need molecular methods. <!-- I think these two points should be very brief, like maybe one sentence for both. - Martin-->
...
<!-- It would be nice with a transition here from previous paragraph. Possible effects of splitting and lumping on turnover. Or what turnover may depend on. e.g. individual size, niche turnover. Martin-->
...
- Short reads
  - 454 [@buee2009] <!--I'm personally not very found of this reference because it’s the kind of sloppy and fast work that some people do to be first rather than doing a good job. You can use it if you like but I think it already has more reference than it deserves.-AR-->, Ion Torrent, Illumina [@schmidt2013].
...
- Long reads
  ...
  - Sequencing depth tradeoff [@Kennedy2018] <!--Maybe this should start the short/long read part. Or be part of a transition between with the connection of OTU/phylogenetic methods and sequencing strategy. - Martin-->
