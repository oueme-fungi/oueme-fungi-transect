...
The DNA extracts were sequenced using four distinct strategies, with two different amplicon lengths (long and short; Figure\ \@ref(fig:rDNA)) and three different technologies (PacBio, Ion Torrent, and Illumina) for the short amplicon.
