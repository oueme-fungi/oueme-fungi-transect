...
The seed alignment modified by truncation at the LR5 primer site, and the reference line was modified to annotate the 5.8S RNA, ITS2 region, and the divergent "D" domains of the 28S RNA as defined by @raue1988.
The CM alignment for each read was then split into alternating more-conserved and less-conserved regions according to these annotations:
...
No attempt was made to remove the short fragment of the SSU from the 5' end of ITS1 in the long amplicons; this is too short to be reliably detected by a CM or the HMMs employed by ITSx.
