...
Forward and reverse Illumina reads were quality controlled (max 3 expected errors in either read) and denoised using `DADA2`.
...
#TODO add Illumina raw reads
#TODO asterisks for mappde ASVs
