...
\title{Comparison of long and short amplicon metabarcoding to determination of fungal species diversity and spatial turnover in an ectomycorrhizal West African woodland}
\subtitle{Presentation for Anna's Group Meeting}
\author{Brendan Furneaux, Mohammad Bahram, Nourou Yorou, Anna Rosling, Martin Ryberg}
\date{13 August, 2019}
