...
(ref:accum-OTU) Each curve represents rarefaction of a single sample or pooled pair of samples. Points at the end of each curve represent the actual read depth and observed OTU richness. Panel at left has enlarged scale to show PacBio more clearly.
