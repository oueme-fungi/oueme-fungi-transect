...
This resulted in `r nrow(readd(sure_kingdoms))` confident kingdom assignments, with `r dplyr::count(read(sure_kingdoms), taxon) %>% glue::glue("{n} assigned to {taxon}, ", last = "and ")`.
