...
```{r correlog, fig.cap="(ref:correlog-cap-s). (ref:correlog-cap)", fig.scap = "(ref:correlog-cap-s)", cache=TRUE, extra.cache=gethash(as.list(keep(light_plan$target, startsWith, "correlog")))}
light_plan %>%
