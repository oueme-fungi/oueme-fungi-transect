...
(ref:qual-check) **(a)** per-base error rate; **(b)** expected number of errors per read. Statistics are based on quality scores assigned by technology-specific basecallers. **THIS NEEDS TO BE MENTIONED IN THE TEXT (addresses reviewer comment)**
