...
```{r buffer-compare-long, fig.cap = "(ref:buffer-compare-long)", cache = TRUE, extra.cache = gethash("buffer_compare_long")}
...
```{r buffer-compare-short, fig.cap = "(ref:buffer-compare-short)", cache = TRUE, extra.cache = gethash("buffer_compare_short"), more.cache=oldtheme}
...
```{r sample-depth, fig.cap = "(ref:sample-depth)", fig.scap = "(ref:sample-depth-s)", cache = TRUE, extra.cache = gethash("conc_plot", "reads_plot")}
...
```{r taxa, fig.cap = "(ref:taxa-s). (ref:taxa)", fig.scap="(ref:taxa-s)", out.width="100%", fig.width = 8, cache=TRUE, extra.cache=gethash("heattree")}
