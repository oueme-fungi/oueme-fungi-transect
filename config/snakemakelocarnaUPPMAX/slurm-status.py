...
for i in range(STATUS_ATTEMPTS):
    try:
        sacct_res = sp.check_output(shlex.split("sacct -P -b -j {} -n -M snowy".format(jobid)))
    ...
    try:
        sctrl_res = sp.check_output(shlex.split("scontrol -M snowy -o show job {}".format(jobid)))
